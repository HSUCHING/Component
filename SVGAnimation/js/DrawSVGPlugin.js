/**
 * Created by chinghsu on 15/11/27.
 */
/*!
 * VERSION: 0.0.8
 * DATE: 2015-11-23
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
	...
	function l(a, b) {
		if (!a)return [0, 0];
		a = g(a), b = b || i(a) + 1;
		var c = j(a), d = c.strokeDasharray || "", e = parseFloat(c.strokeDashoffset), f = d.indexOf(",");
		return 0 > f && (f = d.indexOf(" ")), d = 0 > f ? b : parseFloat(d.substr(0, f)) || 1e-5, d > b && (d = b), [Math.max(0, -e), Math.max(0, d - e)]
	}

	var k, b = "codepen", c = "DrawSVGPlugin", d = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), e = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47), f = function (a) {
	...
	}(window ? window.location.host : ""), j = document.defaultView ? document.defaultView.getComputedStyle : function () {
	};
