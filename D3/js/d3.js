d3 = function() {
  ...
  function z(n, t, e) {
    ...
    var o = "__on" + n,
      a = n.indexOf("."),
      s = R;
    a > 0 && (n = n.substring(0, a));var l = ba.get(n);
    return l && (n = l, s = D), a ? t ? u : r : t ? c : i
  }
  function R(n, t) {
    return function(e) {
      var r = Bo.event;
      Bo.event = e, t[0] = this.__data__;try {
        n.apply(this, t)
      } finally {
        Bo.event = r
      }
  ...
  function ht(n, t, e) {
    n = gt(n), t = gt(t), e = gt(e);var r = rt((.4124564 * n + .3575761 * t + .1804375 * e) / Ya),
  ...
  function ie(n, t, e, r) {
    ...
    return function(a) {
      ...
      function v(n, t) {
        n = Math.max(-Cc, Math.min(Cc, n)), t = Math.max(-Cc, Math.min(Cc, t));var e = f(n, t);
  ...
  function tr(n) {
    for (var t, e, r, u, i = n.x, o = n.y, a = Bc._; a;)
      if (r = er(a, o) - i, r > Na)
        ...
        if (u = i - rr(a, o), !(u > Na)) {
          r > -Na ? (t = a.P, e = a) : u > -Na ? (t = a, e = a.N) : t = e = a;break
        }
        if (!a.R) {
          t = a;break
        }
  ...
  function Nr(n, t) {
    n = Bo.rgb(n), t = Bo.rgb(t);var e = n.r,
      r = n.g,
      u = n.b,
      i = t.r - e,
      o = t.g - r,
  ...
  function Br(n, t) {
    n = Bo.hcl(n), t = Bo.hcl(t);var e = n.h,
      r = n.c,
      u = n.l,
      i = t.h - e,
      o = t.c - r,
  ...
  function Wr(n, t) {
    n = Bo.hsl(n), t = Bo.hsl(t);var e = n.h,
      r = n.s,
      u = n.l,
      i = t.h - e,
      o = t.s - r,
  ...
  function Jr(n, t) {
    n = Bo.lab(n), t = Bo.lab(t);var e = n.l,
      r = n.a,
      u = n.b,
      i = t.l - e,
      o = t.a - r,
  ...
  function ju(n, t, e) {
    n = n._tree, t = t._tree;var r = e / (t.number - n.number);
  ...
  function so(n, t, e) {
    ...
    n.floor = n, n.round = r, n.ceil = u, n.offset = i, n.range = o;var c = n.utc = lo(n);
  ...
  function mo(n, t, e) {
    Bs.lastIndex = 0;var r = Bs.exec(t.substring(e));
    return r ? (n.w = Ws.get(r[0].toLowerCase()), e + r[0].length) : -1
  }
  function yo(n, t, e) {
    Xs.lastIndex = 0;var r = Xs.exec(t.substring(e));
    return r ? (n.w = $s.get(r[0].toLowerCase()), e + r[0].length) : -1
  }
  function xo(n, t, e) {
    ul.lastIndex = 0;var r = ul.exec(t.substring(e, e + 1));
    return r ? (n.w = +r[0], e + r[0].length) : -1
  }
  function Mo(n, t, e) {
    ul.lastIndex = 0;var r = ul.exec(t.substring(e));
  ...
  function bo(n, t, e) {
    Ks.lastIndex = 0;var r = Ks.exec(t.substring(e));
    return r ? (n.m = Qs.get(r[0].toLowerCase()), e + r[0].length) : -1
  }
  function wo(n, t, e) {
    Js.lastIndex = 0;var r = Js.exec(t.substring(e));
  ...
  function Ao(n, t, e) {
    ul.lastIndex = 0;var r = ul.exec(t.substring(e, e + 4));
    return r ? (n.y = +r[0], e + r[0].length) : -1
  }
  function Co(n, t, e) {
    ul.lastIndex = 0;var r = ul.exec(t.substring(e, e + 2));
  ...
  function zo(n, t, e) {
    ul.lastIndex = 0;var r = ul.exec(t.substring(e, e + 3));
  ...
  function Fo(n, t, e) {
    nl.lastIndex = 0;var r = nl.exec(t.substring(e, e + 1));
  ...
  $a.forEach(function(n, t) {
    ...
    function e(n, e, i) {
      arguments.length < 3 && (i = e, e = null);var o = yt(n, t, null == e ? r : u(e), i);
        ...
        do {
          ...
          if (n === u.L) {
            if (t = u.R, t.C && (t.C = !1, u.C = !0, xr(this, u), t = u.R), t.L && t.L.C || t.R && t.R.C) {
              t.R && t.R.C || (t.L.C = !1, t.C = !0, Mr(this, t), t = u.R), t.C = u.C, u.C = t.R.C = !1, xr(this, u), n = this._;break
            }
          } else if (t = u.L, t.C && (t.C = !1, u.C = !0, Mr(this, u), t = u.L), t.L && t.L.C || t.R && t.R.C) {
            t.L && t.L.C || (t.R.C = !1, t.C = !0, xr(this, t), t = u.L), t.C = u.C, u.C = t.L.C = !1, Mr(this, u), n = this._;break
          }
          t.C = !0, n = u, u = u.U
        } while (!n.C);
        n && (n.C = !1)
  ...
  Bo.layout.stack = function() {
    function n(a, c) {
      var s = a.map(function(e, r) {
        ...
        f = e.call(n, l, c);
      s = Bo.permute(s, f), l = Bo.permute(l, f);var h,
        g,
        p,
        v = r.call(n, l, c),
        d = s.length,
  ...
  Bo.layout.histogram = function() {
    ...
    function n(n, i) {
      ...
      function a(n, t) {
        n.x = n._tree.prelim + t;var e = n.children;
        if (e && (r = e.length)) {
          var r,
            u = -1;
      ...
      }), o(l), a(l, -l._tree.prelim);var f = qu(l, Ru),
        h = qu(l, zu),
        g = qu(l, Du),
        p = f.x - e(f, h) / 2,
        v = h.x + e(h, f) / 2,
      ...
      return Pu(l, u ? function(n) {
          n.x *= r[0], n.y = n.depth * r[1],
          delete n._tree
        } : function(n) {
          n.x = (n.x - p) / (v - p) * r[0], n.y = n.depth / d * r[1],
          delete n._tree
        }), s
    }
