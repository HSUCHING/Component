...
(function (a, b) {
  function G(a) {
    ...
    var a, b;p.uaMatch = function (a) {
      ...
      bV = ["Webkit", "O", "Moz", "ms"],
      bW = p.fn.toggle;p.fn.extend({ css: function (a, c) {
    ...
    p.cssHooks[a + b] = { expand: function (c) {
      ...
      cg = /^(?:select|textarea)/i;p.fn.extend({ serialize: function () {
    ...
    if (typeof a != "string" && ct) return ct.apply(this, arguments);if (!this.length) return this;var e,
        ...
        g,
        h = this,
        i = a.indexOf(" ");return i >= 0 && (e = a.slice(i, a.length), a = a.slice(0, i)), p.isFunction(c) ? (d = c, c = b) : typeof c == "object" && (f = "POST"), p.ajax({ url: a, type: f, dataType: "html", data: c, complete: function (a, b) {
    ...
    p[c] = function (a, d, e, f) {
      ...
      cE = /\?/,
      cF = /(=)\?(?=&|$)|\?\?/,
      cG = p.now();p.ajaxSetup({ jsonp: "callback", jsonpCallback: function () {
...
//# sourceMappingURL=jquery-1.8.0.min-compiled.js.map